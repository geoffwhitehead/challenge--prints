...
// import { path as userPaths } from "@routes/user-router";
...
//         const retUsers: IUser[] = (respUsers as IUser[]).map((user: IUser) => {
...
//     it(`should return a JSON object with the error message of ${UserNotFoundError.Msg}
//             and a code of "${StatusCodes.NOT_FOUND}" if the id was not found.`, (done) => {
//       // Call api
